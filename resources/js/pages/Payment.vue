...
<template>
  <div class="min-h-screen font-[Poppins] flex flex-col md:flex-row bg-white">
    ...
    <!-- KANAN - RINCIAN -->
    <div class="w-full md:w-1/2 bg-white p-8 border-l border-black flex flex-col">
    ...
    <!-- KIRI - FORM -->
    <div class="w-full md:w-2/2 bg-[#e6bbaa] p-8 relative">
      ...
      <div class="flex flex-col bg-white border border-black rounded-xl overflow-hidden w-48 h-38">
  ...
  <button class="w-80 mt-4 text-white py-3 rounded-xl bg-[#53776c] hover:bg-[#31463f] transition">
    Bayar Sekarang
  </button>
</div>
