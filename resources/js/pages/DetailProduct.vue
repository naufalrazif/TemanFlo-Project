<template>
  <div class="bg-white min-h-screen px-6 py-10 font-[Poppins] text-[#000000]">
    ...
    <!--judul-->
    <div class="flex-1">
        <h1 class="text-4xl font-semibold mb-2">Buket Bunga Mawar Pink</h1>
        <p class="text-2xl font-light mb-4">Rp. 70.000</p>
    ...
    <div class="flex flex-col md:flex-row gap-10 items-start mb-12">
      <!-- Gambar -->
      <img :src="'/images/5.jpg'" alt="..." class="w-[350px] h-[450px]"/>

      <!-- Detail -->
      <div class="flex-1">
        <p class="text-xl font-semibold mb-2">Deskripsi</p>
        <p class="flex justify-between text-xl font-light mb-4 w-[546] h-[209]">
        Rayakan momen spesial dengan Buket Bunga Mawar Pink persembahan klasik yang tak lekang oleh waktu. 
        Buket ini secara khusus menampilkan keindahan dan kelembutan dari Mawar Pink segar pilihan,             bunga yang dikenal sebagai simbol kekaguman dan kasih sayang yang tulus.
        Setiap tangkai Mawar Pink dipilih dengan standar kualitas tertinggi, 
        memiliki kelopak yang mekar sempurna dan aroma yang menenangkan. 
        Buket ini bukan hanya hadiah, tetapi sebuah pesan elegan yang diungkapkan tanpa kata-kata.
        </p>

        <div class="mb-4">
          <p class="text-xl font-semibold mb-2">Tema:</p>
          <p class="flex justify-between text-xl font-light mb-4 w-[546] h-[209]">Wedding, Graduation, Birthday</p>
        </div>

        <div class="mb-6">
          <p class="text-xl font-semibold mb-2">Ukuran:</p>
          <p class="flex justify-between text-xl font-light mb-4 w-[546] h-[209]">Sedang</p>
        </div>
